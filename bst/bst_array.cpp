...
public:
    ...
    void Delet(treeNode *node, int data);
    void Find(treeNode *node, int data);
    void Inorder(treeNode *node);
    void Preorder(treeNode *node);
    void Postorder(treeNode *node);
};
void BST:: FindMin(treeNode *node)
{
    if(node==NULL)
    {
...
void BST:: FindMax(treeNode *node)
{
    if(node==NULL)
    {
        /* There is no element in the tree */
...
void BST :: Delet(treeNode *node, int data)
{
    treeNode *temp;
    if(node==NULL)
    {
...
void BST :: Find(treeNode *node, int data)
{
    if(node==NULL)
    {
